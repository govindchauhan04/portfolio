            ...
            <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-cyan-500/40 shadow-[0_0_40px_rgba(0,229,255,0.15)] grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-5 relative group overflow-hidden rounded-2xl border border-slate-700 shadow-2xl">
                <img
                  ...
                  className="w-full h-72 sm:h-96 object-contain bg-slate-950 group-hover:scale-[1.02] transition-transform duration-700"
                />
              ...
              >
                ...
                >
                  <img
                    src={project.image}
                    alt={project.title}
                    className="w-full h-64 sm:h-80 object-contain bg-slate-950 group-hover:scale-[1.02] transition-transform duration-500"
                  />
